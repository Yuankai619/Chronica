...
- **Axis labels:** one word per spoke (Jobs-minimal). Inter sans 11px weight 600. Place 16px outside the outer ring along the axis vector. Top/bottom = `text-anchor="middle"`; right side = `start`; left side = `end`.
...
<polygon points="500,96 622,201 585,356 415,356 363,196"
         fill="rgba(61,107,229,0.18)" stroke="#3d6be5" stroke-width="1.8"/>
```
...
|---|---|---|---|
| Focal | `accent` | `#3d6be5` | `#7fa0f0` |
| 1 | `series-1` (sage) | `#5f7a8c` | `#8aa3b4` |
| 2 | `series-2` (dusty-blue) | `#7c8f6f` | `#9caf8f` |
...
- **Mono-font axis labels.** Names go in Inter sans (the global rule). Mono is for technical sublabels only.
