...
- **Components** are a small circle `r=6`, filled `paper` with an `ink` 1px stroke. Label in Inter sans 12px weight 600, placed 12px above the dot, `text-anchor="middle"`. An optional Geist Mono 9px `muted` sublabel can sit under the dot for a technical qualifier — use sparingly.
