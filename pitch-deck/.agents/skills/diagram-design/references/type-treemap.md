...
- **Labels sit inside the cell**, top-left, 16px in from the edge: name in Inter 12–14px 600, value in Geist Mono 9px on the next line. Three tiers by cell size:
...
<rect x="X" y="Y" width="W" height="H" rx="2" fill="#fafbfc"/>
<!-- Cell body -->
<rect x="X" y="Y" width="W" height="H" rx="2" data-share="18.29" fill="rgba(27,42,74,0.16)" stroke="rgba(27,42,74,0.30)" stroke-width="1"/>
<text x="X+16" y="Y+28" fill="#1b2a4a" font-size="13" font-weight="600" font-family="'Inter', sans-serif">NAME</text>
<text x="X+16" y="Y+46" fill="#6b7789" font-size="9" font-family="'Geist Mono', monospace">VALUE · SHARE</text>
```

Focal cell: replace the fill with `rgba(61,107,229,0.16)` and the stroke with `#3d6be5` at 1.5px.
