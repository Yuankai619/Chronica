...
<polyline points="x0,y0 x1,y1 x2,y2 ..."
          fill="none" stroke="#3d6be5" stroke-width="1.8" stroke-linejoin="round"/>
<!-- Dots at each point (focal only) -->
<circle cx="x0" cy="y0" r="4" fill="#3d6be5"/>

<!-- Non-focal series -->
<polyline points="x0,y0 x1,y1 ..."
          fill="none" stroke="#5f7a8c" stroke-width="1.2" stroke-linejoin="round"/>
```
...
<text data-axis="from" data-state="BEFORE" x="320" y="440" fill="#6b7789" font-size="9" font-family="'Geist Mono', monospace" letter-spacing="0.14em" text-anchor="middle">BEFORE</text>
<text data-axis="to" data-state="AFTER" x="680" y="440" fill="#6b7789" font-size="9" font-family="'Geist Mono', monospace" letter-spacing="0.14em" text-anchor="middle">AFTER</text>
...
<line data-series="Recommender" data-from="238" data-to="431"
      x1="320" y1="303.5" x2="680" y2="140.5" stroke="#3d6be5" stroke-width="2.4"/>
<circle cx="320" cy="303.5" r="4" fill="#3d6be5"/>
<circle cx="680" cy="140.5" r="4" fill="#3d6be5"/>
<text data-series="Recommender" data-end="from" data-role="name" x="272" y="307" fill="#1b2a4a" font-size="11" font-weight="600" font-family="'Inter', sans-serif" text-anchor="end">Recommender</text>
<text data-series="Recommender" data-end="from" x="304" y="307" fill="#6b7789" font-size="9" font-family="'Geist Mono', monospace" text-anchor="end">238</text>
<text data-series="Recommender" data-end="to" x="696" y="144" fill="#6b7789" font-size="9" font-family="'Geist Mono', monospace">431</text>
<text data-series="Recommender" data-end="to" data-role="name" x="728" y="144" fill="#1b2a4a" font-size="11" font-weight="600" font-family="'Inter', sans-serif">Recommender</text>
```

Non-focal series: `stroke="rgba(27,42,74,0.68)"` at `stroke-width="1.2"`, dots `r=3`, names at `font-weight="500"`.
...
```svg
<line data-ridge="checkout-api" data-role="baseline" x1="320" y1="320" x2="680" y2="320" stroke="rgba(27,42,74,0.25)" stroke-width="1"/>
<path data-ridge="checkout-api" data-baseline="320" data-bins="0,1,6,17,21,14,8,6,7,9,7,4,0" d="M320,320 L350,317.6 L380,305.6 L410,279.2 L440,269.6 L470,286.4 L500,300.8 L530,305.6 L560,303.2 L590,298.4 L620,303.2 L650,310.4 L680,320 Z" fill="rgba(61,107,229,0.16)" stroke="#3d6be5" stroke-width="2.4" stroke-linejoin="round"/>
<text data-ridge="checkout-api" data-role="name" x="304" y="323.5" fill="#1b2a4a" font-size="11" font-weight="600" font-family="'Inter', sans-serif" text-anchor="end">checkout-api</text>
<text data-ridge="checkout-api" data-role="range" x="696" y="323.5" fill="#6b7789" font-size="9" font-family="'Geist Mono', monospace">40–440 ms</text>
<text data-tick="2" data-bin="240" x="500" y="400" fill="#6b7789" font-size="9" font-family="'Geist Mono', monospace" letter-spacing="0.14em" text-anchor="middle">240</text>
```
